 ...
 * 
 * @Repository public interface VacantLandDataEntryRep extends
 * JpaRepository<VacantLandDataEntry, Integer>{
 * 
 ...
 * 
 * 
 * @Query(value ="select mandal_id,mandal_name from mandal_master", nativeQuery
 * = true) List<Map<String,String> > findAllMandals();
 * 
 * 
 * }
 */